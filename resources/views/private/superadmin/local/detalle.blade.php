                    ...
                    <div class="flex-grow-1"><br>
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="mr-3">
                                ...
                                <div class="d-flex flex-wrap my-2">
                                    ...
                                    <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                        ...
                                        <!--end::Svg Icon-->
                                    </span>{{ $local->direccion }}, Viña del Mar</a>
                                </div>
                                <!--end::Contacts-->
                            </div>
                            <!--begin::User-->
                            ...
                            <div class="my-lg-0 my-1">
                                ...
                                <a href="{{ asset('private/superadmin/menu/'.$local->id) }}" class="btn btn-sm btn-light-success font-weight-bolder text-uppercase">Ver a Menú</a>
