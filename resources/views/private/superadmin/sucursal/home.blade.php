                ...
                <div class="d-flex">
                    ...
                    {{-- <div class="flex-shrink-0 mr-7">
                        <div class="symbol symbol-50 symbol-lg-120">
                            <img alt="Pic" src="/metronic/theme/html/demo5/dist/assets/media//users/300_1.jpg">
                        </div>
                    </div> --}}
                    <!--end::Pic-->
                    <!--begin: Info-->
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="mr-3">
                                <!--begin::Name-->
                                <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{ $sucursales->nombre }}
                            ...
                            <div class="my-lg-0 my-1">
                                ...
                                <a href="#" class="btn btn-sm btn-light-info font-weight-bolder text-uppercase">Editar Sucursal</a>
                                <a href="{{ asset('private/superadmin/menu/'.$sucursales->id) }}" class="btn btn-sm btn-light-success font-weight-bolder text-uppercase">ir a Menú</a>
                                <a href="{{ asset('private/superadmin/sucursal/qr/'.$sucursales->code) }}"; class="btn btn-sm btn-light-warning font-weight-bolder text-uppercase">Generar  QR</a>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Title-->
