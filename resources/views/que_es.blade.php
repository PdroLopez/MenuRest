...
<div class="d-flex flex-row-fluid bgi-size-cover bgi-position-top" style="background-image: url('assets/media/bg/bg-9.jpg')">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center pt-25 pb-35">
            <h3 class="font-weight-bolder text-dark mb-0">Que es Bingo?</h3>
        </div>
    </div>
</div>
<div class="content mt-n25  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">Nosotros</h2>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingOne1">
                                            <div class="card-title" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1" role="button">
                                                <span class="svg-icon svg-icon-primary"><!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo5/dist/assets/media/svg/icons/Navigation/Angle-double-right.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                ...
                                                <div class="card-label text-dark pl-4">Lorem ipsum dolor sit amet?</div>
                                            </div>
                                        </div>
                                        <div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1" data-parent="#accordionExample1">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">
                                                Lorem ipsum dolor sit amet consectetur adipiscing elit, est a euismod congue auctor vehicula morbi dapibus, non hac phasellus enim donec nisl. Justo dis quam arcu nunc aliquet aliquam lacinia odio convallis turpis, quisque volutpat scelerisque aptent tincidunt feugiat lobortis magna libero, primis in litora gravida eu purus vulputate pretium condimentum. Etiam libero nec curae eget quis semper vitae hac, aptent nisl rutrum mus dignissim sodales facilisi ultricies nullam, dui metus venenatis hendrerit tortor nascetur justo.
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">Juego</h2>
                                <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="accordionExample2">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordionExample2" style="">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">
                                                Lorem ipsum dolor sit amet consectetur adipiscing elit, est a euismod congue auctor vehicula morbi dapibus, non hac phasellus enim donec nisl. Justo dis quam arcu nunc aliquet aliquam lacinia odio convallis turpis, quisque volutpat scelerisque aptent tincidunt feugiat lobortis magna libero, primis in litora gravida eu purus vulputate pretium condimentum. Etiam libero nec curae eget quis semper vitae hac, aptent nisl rutrum mus dignissim sodales facilisi ultricies nullam, dui metus venenatis hendrerit tortor nascetur justo.
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree2" class="collapse" aria-labelledby="headingThree2" data-parent="#accordionExample2" style="">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">
                                                Lorem ipsum dolor sit amet consectetur adipiscing elit, est a euismod congue auctor vehicula morbi dapibus, non hac phasellus enim donec nisl. Justo dis quam arcu nunc aliquet aliquam lacinia odio convallis turpis, quisque volutpat scelerisque aptent tincidunt feugiat lobortis magna libero, primis in litora gravida eu purus vulputate pretium condimentum. Etiam libero nec curae eget quis semper vitae hac, aptent nisl rutrum mus dignissim sodales facilisi ultricies nullam, dui metus venenatis hendrerit tortor nascetur justo.
                                            </div>
                                        </div>
